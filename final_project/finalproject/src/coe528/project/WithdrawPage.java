 ...
 */
public class WithdrawPage extends Stage {
    
    WithdrawPage(double b,final String username)
        {
                    ...
                    //add prompt 
                    final Text prompt=new Text("Please fill out the information to withdraw money");
                                                            ...
                                                            if(balanceField.getText().isEmpty())
                                                             {
                                                            ...
                                                            else 
                                                                {
                                                                    ...
                                                                    Double newbalance=UpdateBalance(balnacenow,balancedlt);      // update the balance
                                                                    if (newbalance<0)
                                                                    {
                  ...
                  this.setTitle("https://www.bluebank.com/youraccount/withdraw");
                  this.show();
